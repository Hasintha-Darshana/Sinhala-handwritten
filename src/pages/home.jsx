export default function HomePage() {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[#1e3c72] to-[#2a5298] flex flex-col md:flex-row items-center justify-center px-6 py-12">
      {/* Left Content */}
      <div className="w-full md:w-1/2 flex flex-col justify-center text-white space-y-6 md:pr-12">
      ...
      <div className="w-full md:w-1/2 mt-10 md:mt-0 flex justify-center md:ml-12">
        <img
          src="ui.PNG"
          alt="UI Preview"
          className="max-w-full h-auto rounded-2xl shadow-2xl border-4 border-white hover:scale-105 transition-transform duration-300"
        />
      </div>
    </div>
  );
